...
public class TopLikedVideosAdapter extends RecyclerView.Adapter<TopLikedVideosAdapter.VideoViewHolder>{
    ...
    public VideoViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.top_liked_videos_item,parent,false);
        VideoViewHolder videoViewHolder = new VideoViewHolder(view,mListener);
        return videoViewHolder;
    }

    public TopLikedVideosAdapter(ArrayList<Videos> videos){
